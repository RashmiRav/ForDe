...
class PatientProfile extends Component {
  ...
  componentDidMount = async () => {
    ...
    if (localStorage.getItem("authToken")) {
      ...
      // get patient details 
      await axios.get(`/patient/getPatientDetails/${this.state.userId}`, config).then(res => {
        if (res.data.success) {
  ...
  handleUpload = async e => {
    ...
    try {
      ...
      const res = await axios.post(`/patient/upload`, formData, {
  ...
  deletePatientHandler = async () => {
    ...
    try {
      ...
      if (option) {
        ...
        await axios
          .delete(
            `/patient/deletePatientProfile/` + this.state.email,
            config
          )
          .then((res) => {
  ...
  submitDetails = (e) => {
    ...
    if (this.state.address != null && this.state.address != '' && this.state.bloodGroup != null && this.state.bloodGroup != '' && this.state.fullname != '' && this.state.gender != '' && this.state.gender != null && this.state.nicNumber != null && this.state.nicNumber != '' && this.state.phone != '' && this.state.phone != null && this.state.phoneError == '') {
      ...
      axios.put(`/patient/updatePatientDetails`, patient, config).then(res => {
        if (res.data.success) {
