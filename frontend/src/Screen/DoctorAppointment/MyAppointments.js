...
class MyAppointments extends Component {
    ...
    componentDidMount = async () => {
        ...
        // get appointments
        axios.get(`/codebusters/api/patientpvt/appointment/getapointments/${this.state.userId}`).then(res => {
            if (res.data.success) {
                this.setState({
        ...
        axios.get(`/patient/doctors`).then(res => {
            if (res.data.success) {
    ...
    Appointment = () => {
        ...
        if (this.state.appointmentDate == '' && this.state.appointmentTime == '') {
            ...
            // update appointments
            axios.put(`/codebusters/api/patientpvt/appointment/updateapointments`, appointment, config).then(res => {
                if (res.data.success) {
                    alert(res.data.message);
    ...
    onDelete = async (id) => {
        ...
        try {
            ...
            if (option) {
                await axios.delete(`/codebusters/api/patientpvt/appointment/deleteapointments/${id}`)
                    .then((res) => {
    ...
    handlepdf = async (id) => {
        ...
        try {
            ...
            if (option) {
                await axios.post(`/patient/download_pdf/${id}`)
                    .then(() => axios.get(`/patient/download`, { responseType: 'blob' }))
                    .then((res) => {
